...
pub fn validate_header_regarding_parent(
    ...
    // TODO(clabby): This should probably be gated by the chain spec rather than the feature flag
    // so that RETH compiled with the optimism feature flag can still run an L1 node.
