...
use crate::storage::{
    BlockStateDiff, OpProofsStorage, OpProofsStorageResult, OpProofsStorageError,
    mdbx::{MdbxTrieCursor, MdbxStorageCursor, MdbxAccountCursor},
};
...
impl OpProofsStorage for MdbxProofsStorage {
  ...
  async fn fetch_trie_updates(&self, _block_number: u64) -> OpProofsStorageResult<BlockStateDiff> {
    unimplemented!()
  }
